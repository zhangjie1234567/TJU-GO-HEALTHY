  ...
  <view class="container">
    ...
    <view class="ai-plan-section">
      ...
      <view class="ai-plan-card">
        <view class="ai-card-header" @click="!editMode && toggleExpand('diet')">
          <view class="ai-card-title">饮食方案</view>
          <view v-if="!editMode" class="expand-icon" :class="{ expanded: expandedDiet }">›</view>
        </view>
        <view v-if="editMode" class="ai-card-edit">
          <textarea
            class="edit-textarea"
            v-model="editDiet"
            placeholder="请输入饮食方案..."
      ...
      <view class="ai-plan-card">
        <view class="ai-card-header" @click="!editMode && toggleExpand('exercise')">
          <view class="ai-card-title">运动计划</view>
        ...
        <view v-else-if="expandedExercise" class="ai-card-content">
    ...
    <view class="section">
      <view class="section-header">
        ...
        <text class="add-btn" @click="openAddModal">+ 创建</text>
      </view>
      <view class="plans-grid">
        <view
...
const startEdit = () => {
  if (!ensureLoginForAction('修改方案')) return
...
const openAddModal = () => {
  if (!ensureLoginForAction('创建方案')) return
...
const usePlanTemplate = (template) => {
  if (!ensureLoginForAction('使用此方案')) return
  uni.showModal({
    title: '使用模板',
