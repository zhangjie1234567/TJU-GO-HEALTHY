      ...
      <view class="login-card">
        ...
        <view class="privacy-section">
          ...
          <text class="privacy-text">
            本小程序为校园健康管理工具，仅通过微信授权登录（获取登录凭证 code）用于身份识别。我们会记录身高、体重、运动、饮食、饮水等健康数据，用于个人健康管理与数据统计展示；无支付交易功能，不收集姓名、手机号、学号等敏感个人信息。我方严格管控数据安全，不向其他无关第三方泄露、不买卖用户个人信息。
          </text>
      ...
      <view class="privacy-dialog" @click.stop>
        ...
        <scroll-view class="privacy-dialog-body" scroll-y="true">
          <text class="privacy-dialog-text">
            ...
            5. 所有用户私密数据仅账号本人查看，平台不泄露、不共享、不出售任何用户信息。

            6. 开发者严格遵守《个人信息保护法》，妥善存储并保护用户个人隐私数据安全。
          </text>
        </scroll-view>
