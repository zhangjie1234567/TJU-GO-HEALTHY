<template>
  <view class="page">
    <view class="content">
      <text class="page-title">今日菜单 - 菊园</text>
...
const foods = reactive([
  { name: '菊园菜品1', price: 3, score: 7.5 },
  { name: '菊园菜品2', price: 6, score: 8.5 },
  { name: '菊园菜品3', price: 5, score: 8.0 },
  { name: '菊园菜品4', price: 4, score: 7.8 },
  { name: '菊园菜品5', price: 7, score: 8.2 }
])

const specialFoods = reactive([
  { name: '菊园特色菜1', price: 12, score: 9.0 },
  { name: '菊园特色菜2', price: 14, score: 8.8 },
  { name: '菊园特色菜3', price: 10, score: 8.5 }
])
</script>
